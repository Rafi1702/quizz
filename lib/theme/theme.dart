...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onTertiaryContainer: Color(0xff324862),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff006a67),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff177976),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff344e4c),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff152d46),
      onTertiary: Color(0xffffffff),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff344e4c),
      onSecondaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xffaafffb),
      surfaceTint: Color(0xff80d5d1),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xff7cd1cd),
